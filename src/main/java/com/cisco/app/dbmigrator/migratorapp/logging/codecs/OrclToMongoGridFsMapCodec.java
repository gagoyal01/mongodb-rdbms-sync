...
public class OrclToMongoGridFsMapCodec implements CollectibleCodec<OracleToMongoGridFsMap> {

	private Codec<Document> documentCodec;

	public OrclToMongoGridFsMapCodec(Codec<Document> documentCodec) {
		super();
	...
	public OracleToMongoGridFsMap decode(BsonReader reader, DecoderContext decoderContext) {
		...
		return (OracleToMongoGridFsMap) decoder.decodeSyncMap(document);
	}
